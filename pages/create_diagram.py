...
try: 
    ...
    st.markdown(f"<a href='{mailto_link}' target='_blank' style='color: #a2272c; text-transform: uppercase;'>**Daten per E-Mail senden**</a>", unsafe_allow_html=True,help='Öffnen Sie Ihre E-Mail-App mit vorbereitetem Inhalt hier.')
